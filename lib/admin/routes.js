...
module.exports = function(app) {
  ...
  // Admin panel - edit competition (put)
  app.put('/admin/competition', (req, res) => {
    controller.editCompetiton(req, res);
  });
  ...
  // Admin panel - edit bet (put)
  app.put('/admin/bet', (req, res) => {
    controller.editBet(req, res);
  });
  ...
  // Admin panel - add register (post)
  app.post('/admin/register', (req, res) => {
    controller.addRegister(req, res);
  });
